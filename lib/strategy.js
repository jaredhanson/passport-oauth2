...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  if ((req.query && req.query.assertion) || (req.body && req.body.assertion)) {
    function loaded(err, ok, state) {
      ...
      var assertion = (req.query && req.query.assertion) || (req.body && req.body.assertion);
      ...
      var plainAuthorization = `${self._oauth2._clientId}:${self._oauth2._clientSecret}`;
      self._oauth2._customHeaders['Authorization'] = `Basic ${btoa(plainAuthorization)}`;

      self._oauth2.getOAuthAccessToken(assertion, params,
